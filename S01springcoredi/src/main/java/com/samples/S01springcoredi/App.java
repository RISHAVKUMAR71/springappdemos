...
public class App 
{
    ...
    {
       ClassPathXmlApplicationContext springContainer = new ClassPathXmlApplicationContext("com/samples/S01springcoredi/Spring.Config.xml");
...
//       System.out.println(customer);
       ...
       ShoppingCart scart=(ShoppingCart) springContainer.getBean("shoppingcart");
